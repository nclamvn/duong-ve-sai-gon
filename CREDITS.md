# CREDITS — tài sản bên thứ ba (sinh từ `content/assets/manifest.json`, `npm run assets:credits`)

## CC-BY-4.0

Ghi công bắt buộc (hiển thị trong game ở màn capability và tại đây):
...
- corrugated_iron_02 (texture) — Jenelle van Heerden, Sergej Majboroda — https://polyhaven.com/a/corrugated_iron_02
- rusty_metal_02 (texture) — Rob Tuytel — https://polyhaven.com/a/rusty_metal_02
- rusty_painted_metal (texture) — Amal Kumar — https://polyhaven.com/a/rusty_painted_metal
- plywood (texture) — Rob Tuytel — https://polyhaven.com/a/plywood
- metal_plate (texture) — Rob Tuytel — https://polyhaven.com/a/metal_plate
- wooden_military_crate (model) — Prabhjinder Singh — https://polyhaven.com/a/wooden_military_crate
- old_military_crate (model) — Jack Mava — https://polyhaven.com/a/old_military_crate
- plastic_crate_01 (model) — PierreB3D — https://polyhaven.com/a/plastic_crate_01
- cardboard_box_01 (model) — Rahul Chaudhary — https://polyhaven.com/a/cardboard_box_01
- concrete_road_barrier (model) — Amal Kumar — https://polyhaven.com/a/concrete_road_barrier
- propane_tank (model) — Slinc — https://polyhaven.com/a/propane_tank
