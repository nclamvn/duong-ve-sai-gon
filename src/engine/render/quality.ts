...
export const QUALITY: Record<QualityTier, QualityPreset> = {
  low: { tier: 'low', rainCount: 4000, shadowMapSize: 1024, maxPixelRatio: 1, dynamicResolution: true, shadows: true },
  medium: { tier: 'medium', rainCount: 12000, shadowMapSize: 2048, maxPixelRatio: 1.5, dynamicResolution: true, shadows: true },
  high: { tier: 'high', rainCount: 20000, shadowMapSize: 2048, maxPixelRatio: 2, dynamicResolution: true, shadows: true },
};
